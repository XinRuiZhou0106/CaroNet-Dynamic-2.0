...
def compute_iou(box, boxes, box_area, boxes_area):
    ...
    # union = box_area  # gt
    iou = intersection[:] / union  # A/gt

    s = boxes_area[:] / box_area  # s = Srpn/Sgt
...
def compute_overlaps_pro(boxes1, boxes2):
    """Computes IoU overlaps between two sets of boxes.
    boxes1, boxes2: [N, (y1, x1, y2, x2)].
    ...
    proportion=area1/area2
    return proportion

def compute_2box_iou(box1, box2):
    """Computes IoU overlaps between two sets of boxes.
    boxes1, boxes2: [N, (y1, x1, y2, x2)].
    ...
    union = area2 +area1 - intersection
