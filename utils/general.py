...
def check_requirements(file='/data2/bobo/code_1/Carotid_Project/Carotid_yolov5/requirements.txt'):
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, labels=()):
    ...
    nc = prediction.shape[1] - 5  # number of classes 2
